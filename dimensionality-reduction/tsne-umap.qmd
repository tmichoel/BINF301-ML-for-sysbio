...
- L.J.P. van der Maaten and G.E. Hinton. [*Visualizing Data Using t-SNE*](https://www.jmlr.org/papers/volume9/vandermaaten08a/vandermaaten08a.pdf). Journal of Machine Learning Research 9(Nov):2579-2605, 2008.
...
- Becht et al. [*Dimensionality reduction for visualizing single-cell data using UMAP*](https://doi.org/10.1038/nbt.4314)
...
- [github.com/lmcinnes/umap](https://github.com/lmcinnes/umap)
...
See figure from the [UMAP paper](https://arxiv.org/abs/1802.03426).
...
See also: [github.com/berenslab/rna-seq-tsne](https://github.com/berenslab/rna-seq-tsne)