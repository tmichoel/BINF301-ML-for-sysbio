...
- [*Elements of Statistical Learning*](https://hastie.su.domains/ElemStatLearn/): **Section 2.3, 3.1, 3.2, 3.4, 4.4**
- [*An Introduction to Statistical Learning*](https://www.statlearning.com/): **Section 3.1, 6.2**
:::
...
- The elastic net penalty is a compromise, and has the form
    $$\begin{aligned}
          \textcolor{red}{\lambda\sum_{j=1}^p \Bigl(\alpha|\beta_j|+\tfrac12(1-\alpha)\beta_j^2\Bigr)}.
        \end{aligned}$$ 
...
Cross-validation is used to select value for the hyperparameters $\lambda$ and $\alpha$. See [*An Introduction to Statistical Learning*](https://www.statlearning.com/) (Section 6.2.3) 