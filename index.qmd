...
---
This is the website for the second part of the course [BINF301 Genome-scale Algorithms][1]. This part of the course focuses on machine learning algorithms for systems biology.
...
The computational demonstrations for the course were originally developed in [Julia][2], using reactive [Pluto](https://plutojl.org/) notebooks. Python versionsof the notebooks are under construction. It should be possible to run most notebooks on a standard laptop. Students at [UiB](https://www4.uib.no/en) can also make use of [HubroHub](https://hubrohub.uib.no/), the university's JupyterHub service.

The processed data for the course are available on [OneDrive](https://universityofbergen-my.sharepoint.com/:f:/g/personal/tom_michoel_uib_no/IgDB0hCBQO3uTrttIEf_MWggASMu49PeFRydOjaCdKG3x4w). Details about the raw data sources and preprocessing steps are in the [BINF301-code repository](https://github.com/tmichoel/BINF301-ML-for-sysbio-code/).

An appendix contains an [introduction to Julia](julia-intro.qmd) and the minimum required background knowledge on gene regulation, probability theory, linear algebra, and optimization (under construction).
